        ...
        if (ret instanceof RestResult) {
            ...
            if (isSuccess) {
                ...
                operationLogService.insertOperationLog(
                        OperationLogUtil.getOperationLogObj(request, (userId == null || "".equals(userId)) ? "9999" : userId, "成功", module, operation, "操作成功"));
            } else {
                operationLogService.insertOperationLog(
                        OperationLogUtil.getOperationLogObj(request, (userId == null || "".equals(userId)) ? "9999" : userId, "失败", module, operation, errorMessage));
            }
        }
