...
public class UserFileService extends ServiceImpl<UserFileMapper, UserFile> implements IUserFileService {
    ...
    @Override
    public IPage<FileListVO> userFileList(String userId, String filePath, String fileName, Long currentPage, Long pageCount) {
        Page<FileListVO> page = new Page<>(currentPage, pageCount);
        UserFile userFile = new UserFile();
        JwtUser sessionUserBean = SessionUtil.getSession();
        if (userId == null) {
    ...
    @Override
    public IPage<FileListVO> getFileByFileType(Integer fileTypeId, Long currentPage, Long pageCount, String userId, String fileName) {
        Page<FileListVO> page = new Page<>(currentPage, pageCount);
